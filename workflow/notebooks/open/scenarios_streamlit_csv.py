...
def energy_balances(scenarios, sector, onw=100):
    ...
    balances_df = pd.read_csv(
        scenarios + "/csvs/DE_energy_balances.csv", index_col=[0, 1, 2], header=[0, 1, 2, 3]
    )
...
def costs(scenarios, onw=100):
    cost_df = pd.read_csv(
        scenarios + "/csvs/DE_costs.csv", index_col=list(range(4)), header=list(range(4))
    )
...
MAIN_SCENARIOS = "/mnt/e/H2GMA/Github/Europe/analyse-h2g-a-ap3-eu/workflow/results/myopic-default-2025-2050-5-T-H-B-I-A"
NOH2GRID_SCENARIOS = "/mnt/e/H2GMA/Github/Europe/analyse-h2g-a-ap3-eu/workflow/results/myopic-noh2grid-2025-2050-5-T-H-B-I-A"
LOWCARBON_SCENARIOS = "/mnt/e/H2GMA/Github/Europe/analyse-h2g-a-ap3-eu/workflow/results/myopic-low_carbon_budget-2025-2050-5-T-H-B-I-A"
...
h2 = pd.concat(
    {k: energy_balances(scenarios, "Hydrogen_Storage", onw) for k, (scenarios, onw) in SCENARIOS.items()},
    names=NAMES,
)
