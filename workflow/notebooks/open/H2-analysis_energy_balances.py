...
run_name = "H2-DE"
run_name_config = "H2-DE"
run_name_pypsa = "myopicc-eu-climate-goals-default-2025-2050-5-T-H-B-I-A"
config = "config.myopic_main.yaml" 
countries = ["EU"] # EU means all European countries
energy_threshold = 0 # in TWh; different between DE and EU

with open(f"/mnt/e/H2GMA/Github/Europe/analyse-h2g-a-ap3-eu/config/{run_name_config}/" + config) as file:
    config = yaml.safe_load(file)

networks_dict = {
        (cluster, ll, opt + sector_opt, planning_horizon): f"/mnt/e/H2GMA/Github/Germany/pypsa-eur/results/myopic/{run_name_pypsa}"
